...
import receivedQuickReply from './receivedQuickReply';
...
export default function receivedMessage(event: MessagingEvent) {
  ...
  if (messageText) {
    ...
    console.log('Recived a new message: ', messageText);
    switch (
      messageText
        .replace(/[^\w\s]/gi, '')
        .trim()
      ...
      case 'quick reply':
        sendQuickReply(senderID, "Test YO!", [
        {
          content_type: 'text',
          title: 'Japan',
          payload: 'COUNTRY_OF_RESIDENCE:JAPAN'
        },
        {
          content_type: 'text',
          title: 'Outside Japan',
          payload: 'COUNTRY_OF_RESIDENCE:OUTSIDE_JAPAN'
        }
